...
<?
//指定秒數轉向;
echo "<META HTTP-EQUIV=\"refresh\" CONTENT=\"4; URL=poetry_chang_orig.php?PAGE=$PAGE&OM=$OM\">";
?>
<title>刪除出處已使用</title>
<style type="text/css">
<!--
...
<div align="center">
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="710" height="38"  border="3" align="center" cellpadding="5" cellspacing="1" bordercolor="#CCCCCC">
    <tr class="unnamed1">
      <th width="74%" height="30" bordercolor="#FFFFFF" bgcolor="#E1E1E1" class="style8" scope="col">原舊有出處 <? echo "<span class=\"style9\">".$OM."</span>"; ?> ，已在歌曲中使用，請先更換出處名稱！才能刪除此歌曲出處！</th>
    </tr>
  </table>
  </div>
</body>
