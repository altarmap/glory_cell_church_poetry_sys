...
.style48 {font-family: "華康楷書體W5(P)"; font-size: 28px; color: #FFFFFF; }
.style54 {font-size: 28px; font-family: "華康楷書體W5(P)"; color: #333333; }
-->
</style>
...
<div align="center">
  <p>&nbsp;</p>
  <table width="55%" height="152"  border="3" align="center" cellpadding="5" cellspacing="1" bordercolor="#CCCCCC">
    <tr bgcolor="#333333">
      <th height="50" colspan="2" class="style30" scope="col"> <span class="style45">MP3 撥放曲目 　　 <span class="style44"><span class="style19"><? echo substr($DATE_F[CRT_TIME],0,4)."/".substr($DATE_F[CRT_TIME],5,2)."/".substr($DATE_F[CRT_TIME],8,2)."　".substr($DATE_F[CRT_TIME],11,2).":".substr($DATE_F[CRT_TIME],14,2).":".substr($DATE_F[CRT_TIME],17,2); ?>　清單編號：<? echo sprintf("%05d",$L); ?></span></span></span></th>
    </tr>
    <tr bgcolor="#CCCCCC">
      <th width="22%" height="46" bordercolor="#FFFFFF" bgcolor="#666666" scope="col"><span class="style4"><span class="style15"><span class="style48">歌　曲</span></span></span></th>
      <th width="78%" height="46" bordercolor="#FFFFFF" bgcolor="#666666" scope="col"><span class="style15"><span class="style48">歌　曲　名　稱</span></span></th>
    </tr>
    <?
   if($DATA_NUM==0){
...
echo "<tr bgcolor=\"#FFFFFF\"><th height=\"47\" bordercolor=\"#FFFFFF\" scope=\"col\"><span class=\"style4\"><span class=\"style15\"><span class=\"style54\">".sprintf("%05d",$SONG_DATA[$i][SONG_NBR])."</span></span></span></th><th height=\"47\" bordercolor=\"#FFFFFF\" scope=\"col\"><span class=\"style15\"><span class=\"style54\"><a href=\"javascript:mp3(".$SONG_DATA[$i][SONG_NBR].");\">".$POETRY_DATA_F[SONG_NM]."</a></span></span></th></tr>";
