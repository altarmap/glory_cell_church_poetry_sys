...
<?
//指定秒數轉向;
echo "<META HTTP-EQUIV=\"refresh\" CONTENT=\"2; URL=/POETRY_SYS/admin_crt_usernm.htm\">";
?>
<title>新增管理者成功</title>
<style type="text/css">
<!--
...
<div align="center">
  ...
  <table width="450" height="38"  border="3" align="center" cellpadding="5" cellspacing="1" bordercolor="#CCCCCC">
    <tr class="unnamed1">
      <th width="74%" height="30" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><span class="style8">新增成功！</span></th>
    </tr>
  </table>
</div>
</body>
