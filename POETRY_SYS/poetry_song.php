...
<div align="center"> 
  ...
  <table width="1000" height="54"  border="3" align="center" cellpadding="5" cellspacing="1" bordercolor="#CCCCCC">
    <tr bgcolor="#333333"> 
      <th width="100%" height="46" bordercolor="#FFFFFF" scope="col"><input onClick="location.href='poetry_play_song.php?L=<? echo $L; ?>&I=<? echo $I; ?>'" type="button" name="Submit" value="回曲目"></th>
    </tr>
  </table>
</div>
</body>
