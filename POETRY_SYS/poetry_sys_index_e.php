...
$song_num_q="select SEQ_NBR from POETRY_DATA where SONG_LANG=\"2\"";
...
<div align="center">
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="72%" height="162"  border="3" align="center" cellpadding="5" cellspacing="1" bordercolor="#CCCCCC">
    <tr>
      <th height="30" colspan="5" bgcolor="#666666" class="style3" scope="col"> 詩 　歌 　總 　目　 錄</th>
    </tr>
    <tr>
      <th width="10%" height="30" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><div align="center"><span class="style10"><a href="poetry_sys_index_e.php?L=<? echo $L; ?>&PAGE=<? if($PAGE==""){ echo "1";}else{ echo $PAGE; } ?>&index=S">編號</a></span></div></th>
      <th width="40%" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><span class="style10"><a href="poetry_sys_index_e.php?L=<? echo $L; ?>&PAGE=<? if($PAGE==""){ echo "1";}else{ echo $PAGE; } ?>&index=N">名　　　稱</a></span></th>
      <th width="9%" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><span class="style10"><a href="poetry_sys_index_e.php?L=<? echo $L; ?>&PAGE=<? if($PAGE==""){ echo "1";}else{ echo $PAGE; } ?>&index=KE">音調</a></span></th>
      <th width="21%" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><span class="style4"><span class="style10"><a href="poetry_sys_index_e.php?L=<? echo $L; ?>&PAGE=<? if($PAGE==""){ echo "1";}else{ echo $PAGE; } ?>&index=K">類　別</a></span></span></th>
      <th width="20%" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><span class="style4"><span class="style10"><a href="poetry_sys_index_e.php?L=<? echo $L; ?>&PAGE=<? if($PAGE==""){ echo "1";}else{ echo $PAGE; } ?>&index=O">出　處</a></span></span></th>
    </tr>
<? 
if($song_num==0){
   ...
   $song_data_query = "select * from POETRY_DATA where SONG_LANG=\"2\" ".$order." limit $PAGE,10";
...
$p=1;
while($p<=$PAGE_NUM){
echo "<a href=\"poetry_sys_index_e.php?L=".$L."&index=".$index."&PAGE=".$p."\"><u>".$p."</u> </a>";
$p++;
}
echo "</th></tr>";
break;
