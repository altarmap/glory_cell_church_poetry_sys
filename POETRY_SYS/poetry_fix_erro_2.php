...
<?
//指定秒數轉向;
echo "<META HTTP-EQUIV=\"refresh\" CONTENT=\"2; URL=poetry_fix.php?SN=".$SN."\">";
?>
<title>重新輸入</title>
<style type="text/css">
<!--
...
<div align="center">
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="523" height="38"  border="3" align="center" cellpadding="5" cellspacing="1" bordercolor="#CCCCCC">
    <tr class="unnamed1">
      <th width="74%" height="30" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><span class="style8">您所填寫的資料與舊資料相同！請重新輸入！</span></th>
    </tr>
  </table>
  </div>
</body>
