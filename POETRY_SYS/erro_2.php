...
<?
//指定秒數轉向;
echo "<META HTTP-EQUIV=\"refresh\" CONTENT=\"2; URL=admin_fix_usernm.php?PAGE=$PAGE\">";
?>
<title>密碼相同</title>
<style type="text/css">
<!--
...
<div align="center">
  ...
  <table width="450" height="38"  border="3" align="center" cellpadding="5" cellspacing="1" bordercolor="#CCCCCC">
    <tr class="unnamed1">
      <th width="74%" height="30" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><span class="style8">您輸入的密碼與舊密碼相同，請確認後重新輸入！</span></th>
    </tr>
  </table>
  </div>
</body>
