...
<?
//指定秒數轉向;
echo "<META HTTP-EQUIV=\"refresh\" CONTENT=\"4; URL=poetry_sys_playlist.php?L=".$L."\">";
?>
<title>修改失敗</title>
<style type="text/css">
<!--
...
<div align="center">
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="487" height="38"  border="3" align="center" cellpadding="5" cellspacing="1" bordercolor="#CCCCCC">
    <tr class="unnamed1">
      <th width="74%" height="30" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><span class="style8">修改失敗！您修改的歌曲順序重覆，請確認您歌曲的順序！</span></th>
    </tr>
  </table>
  </div>
</body>
