...
<form name="form1" method="post" action="poetry_sys_find_sear.php?L=<? echo $L; ?>&S=8">
<div align="center">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="38%" height="100"  border="3" align="center" cellpadding="5" cellspacing="1" bordercolor="#CCCCCC">
    <tr>
      <th height="30" colspan="2" bgcolor="#666666" class="style3" scope="col"> 詩歌簡譜查詢</th>
    </tr>
    <tr>
      <th height="30" colspan="2" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><span class="style4"><span class="style10">輸入歌曲簡譜</span></span><span class="style4">
<span class="style12"><span class="style10">
<input name="WORD_FIND" type="text" id="WORD_FIND" size="16" maxlength="128">
