...
<?
//指定秒數轉向;
echo "<META HTTP-EQUIV=\"refresh\" CONTENT=\"2; URL=/POETRY_SYS/poetry_sys_playlist.php?L=".$L."\">";
?>
<title>修改成功</title>
<style type="text/css">
<!--
...
<div align="center">
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="286" height="38"  border="3" align="center" cellpadding="5" cellspacing="1" bordercolor="#CCCCCC">
    <tr class="unnamed1">
      <th width="74%" height="30" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><span class="style8">成功修改完成！</span></th>
    </tr>
  </table>
  </div>
</body>
