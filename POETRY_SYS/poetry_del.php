...
if ($login_PRVL[PRVL_ID]== 1 ||$login_PRVL[PRVL_ID]==2){
	$del_data_query = "select * from POETRY_DATA where SEQ_NBR=\"".$SN."\"";
	$del_data_result = mysql_query($del_data_query, $MyLink);
	$del_data= mysql_fetch_array($del_data_result);
//查詢修改者類別;
if($del_data[SONG_KIND]==0){
		  $KIND="selected";
		  }else{
		  $KIND="";
		  }
//查詢修改者出處;
if($del_data[SONG_ORIG]==0){
		  $KINDO="selected";
		  }else{
		  $KINDO="";
		  }		  
...
<body>
<form action="poetry_del_action.php" method="post" enctype="multipart/form-data" name="form1">
<div align="center">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="49%" height="313"  border="3" align="center" cellpadding="5" cellspacing="1" bordercolor="#CCCCCC">
    <tr>
      <th height="30" colspan="5" bgcolor="#666666" class="style3" scope="col">敬拜詩歌 管理系統 刪除歌曲 </th>
    </tr>
    <tr class="unnamed1">
      <th height="30" colspan="2" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><div align="center" class="style11"><a href="Poetry_New_Lang.htm">名稱</a>
              <input disabled name="SONG_NM" type="text" id="SONG_NM" size="16" maxlength="128" value= "<? echo $del_data[SONG_NM]; ?>">
      </div></th>
      <th colspan="3" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><div align="left"><span class="style11">　　編號：<? echo sprintf("%05d",$del_data[SEQ_NBR]);?>
...
?>
        ...
        <span class="style11">        </span>      </span></span></th>
...
?>
    ...
    <tr class="unnamed1">
      <th height="30" colspan="2" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><span class="style4"><span class="style10">調性
              <select name="SONG_KEY" id="SONG_KEY" disabled>
      ...
      <th height="30" colspan="3" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><span class="style11">簡譜
            <input name="SONG_MUSIC" type="text" id="SONG_MUSIC" size="16" maxlength="128" value="<? echo $del_data[SONG_MUSIC]; ?>" disabled>
      </span></th>
    </tr>
    <tr valign="top" class="unnamed1">
      <th height="119" colspan="5" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><div align="center" class="style4">歌詞<span class="style10">
          <textarea name="SONG_CHAR" cols="45" rows="10" wrap="VIRTUAL" id="SONG_CHAR" disabled><? echo $del_data[SONG_CHAR]; ?></textarea>
      </span></div></th>
    </tr>
    <tr class="unnamed1">
    ...
    <tr class="unnamed1">
      ...
      <th width="13%" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><input name="DEL" type="submit" id="DEL" value="刪除"></th>
      <th width="13%" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><input onClick="location.href='poetry_enter_del.html'" name="Cencle" type="button" id="Cencle" value="取消"></th>
    </tr>
  </table>
  </div>
</form>
