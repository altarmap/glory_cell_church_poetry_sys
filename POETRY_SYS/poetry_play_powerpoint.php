...
<div align="center">
  ...
  <table width="1000" height="152"  border="3" align="center" cellpadding="5" cellspacing="1" bordercolor="#CCCCCC">
    <tr bgcolor="#333333">
      <th height="50" colspan="2" class="style30" scope="col"> <span class="style45">投影片撥放曲目 　<span class="style44"><span class="style19"><? echo substr($DATE_F[CRT_TIME],0,4)."/".substr($DATE_F[CRT_TIME],5,2)."/".substr($DATE_F[CRT_TIME],8,2)."　".substr($DATE_F[CRT_TIME],11,2).":".substr($DATE_F[CRT_TIME],14,2).":".substr($DATE_F[CRT_TIME],17,2); ?>　清單編號：<? echo sprintf("%05d",$L); ?></span></span></span></th>
    </tr>
    <tr bgcolor="#CCCCCC">
      ...
      <th width="80%" height="46" bordercolor="#FFFFFF" bgcolor="#666666" scope="col"><span class="style15"><span class="style56"> 
        歌　曲　名　稱</span></span></th>
    </tr>
    <?
   if($DATA_NUM==0){
...
//echo "<tr bgcolor=\"#FFFFFF\"><th height=\"80\" bordercolor=\"#FFFFFF\" scope=\"col\"><span class=\"style57\">".sprintf("%05d",$SONG_DATA[$i][SONG_NBR])."</span></th><th height=\"47\" bordercolor=\"#FFFFFF\" scope=\"col\"><span class=\"style57\"><a href=\"powerpoint/".$SONG_DATA[$i][SONG_NBR].".pps#".$SONG_DATA[$i][4]."\">".$POETRY_DATA_F[SONG_NM]."</a></span></th></tr>";
echo "<tr bgcolor=\"#FFFFFF\"><th height=\"80\" bordercolor=\"#FFFFFF\" scope=\"col\"><span class=\"style57\">".sprintf("%05d",$SONG_DATA[$i][SONG_NBR])."</span></th><th height=\"47\" bordercolor=\"#FFFFFF\" scope=\"col\"><span class=\"style57\"><a href=\"poetry_powerpoint.php?L=".$L."&I=".$I."&SONG=".$SONG_DATA[$i][SONG_NBR]."&CODA=".$SONG_DATA[$i][4]."\">".$POETRY_DATA_F[SONG_NM]."</a></span></th></tr>";
$i++;
$n++;
}
}
  ...
  <span class="style15"><span class="style56">
