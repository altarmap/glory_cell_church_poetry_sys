...
if($checkbox!="checkbox"){
	header("Location:del_kind_erro.php?PAGE=$PAGE");
	}
	else{
		}
...
<form action="poetry_del_kind.php" method="post" enctype="multipart/form-data" name="form1">
<div align="center">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="50%" height="38"  border="3" align="center" cellpadding="5" cellspacing="1" bordercolor="#CCCCCC">
    <tr class="unnamed1">
      <th width="74%" height="30" bordercolor="#FFFFFF" bgcolor="#E1E1E1" scope="col"><span class="style4">您確定要刪除歌曲類別嗎？</span><span class="style11"><span class="style4"><span class="style10">        
      <input type="submit" name="Submit" value="是">        
        <input onClick="location.href='poetry_kind.php?PAGE=<? echo $PAGE; ?>'" name="Cencle" type="button" id="Cencle" value="否">
